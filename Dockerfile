FROM openjdk:8-jre
MAINTAINER Suleyman İdinak <suleyman.idinak@outlook.com>

ARG ORACLE_JDK_VERSION=7u80
ARG ORACLE_JDK_BUILD_NUMBER=b15
ARG ORACLE_JDK_DOWNLOAD_KEY=1524441038_507adf51312aa0b89b34e0f972df86ac
...
RUN curl -o /tmp/jce_policy-8.zip -H "Cookie:oraclelicense=accept-securebackup-cookie" -L -v http://download.oracle.com/otn-pub/java/jce/7/jce_policy-7.zip && \
unzip -d /tmp /tmp/jce_policy-7.zip && \
